...
this.repositorio=reposity;
    ...
    private void estadisticasGenerales() {
        ...
        System.out.println("Estas son las estadisticas generales");
    ...
    private void top5LibrosDescargados() {
        ...
        System.out.println("Este es el top 5 de descargas");
    ...
    private void mostrarLibrosPorIdioma() {
        System.out.println("""
                Introduzca el lenguaje del libro:
                ES: Español
                EN: Ingles
                FR: Frances
                IT: Italiano
        ...
        try {
            ...
            System.out.println("El idioma que introdujo existe\n");
        }
    ...
    private DatosLibros buscarLibroWeb(){
        System.out.println("Introduzca el nombre del libro que desea buscar en la web");
        ...
        if (libroBuscado.isPresent()){
            ...
            System.out.println("El libro no fue encontrado, pruebe otro titulo\n");
            return null;
        }
    }
    ...
    private void buscarLibroWebPrincipal(){
        ...
        if(datosOpcional.isPresent()) {
            ...
            try {
                ...
                System.out.println("Este libro ya fue guardado.\n");
            }
        }
    }
